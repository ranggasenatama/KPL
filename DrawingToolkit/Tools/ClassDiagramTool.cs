...
namespace DrawingToolkit.Tools
{
    public class ClassDiagramTool : CreateTool
    {
        ...
        public override void ToolMouseMove(object sender, MouseEventArgs e)
        {
            if (e.Button == MouseButtons.Left)
            {
                RectangleWithText rectangle1 = (this.classDiagram.drawingObjects[0] as RectangleWithText);
                Text text1 = (rectangle1.drawingObjects[0] as Text);
                RectangleWithText rectangle2 = (this.classDiagram.drawingObjects[1] as RectangleWithText);
                Text text2 = (rectangle2.drawingObjects[0] as Text);
                RectangleWithText rectangle3 = (this.classDiagram.drawingObjects[2] as RectangleWithText);
